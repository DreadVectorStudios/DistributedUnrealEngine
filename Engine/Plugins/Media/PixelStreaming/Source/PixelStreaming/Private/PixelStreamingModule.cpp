...
IPixelStreamingModule* FPixelStreamingModule::GetModule()
{
    ...
    IPixelStreamingModule* Module = FModuleManager::Get().GetModulePtr<IPixelStreamingModule>("PixelStreaming");
    if(Module)
    {
...
void FPixelStreamingModule::SendData(TArray<uint8>& ByteData, FString& MimeType, FString& FileExtension)
{	
	Streamer->SendData(ByteData, MimeType, FileExtension);
}
